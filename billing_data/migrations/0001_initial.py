...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('stock_data', '0004_rename_unit_customer_price_stockitem_customer_unit_price'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bill_services', to='services_data.employee')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bill_services', to='services_data.service')),
            ],
        ),
        migrations.CreateModel(
            name='BillItems',
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='inventory_data.item')),
                ('stock_item_unique', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bill_items', to='stock_data.stockitemunique')),
            ],
        ),
    ]
