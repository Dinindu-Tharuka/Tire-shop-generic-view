...
class StockItemUnique(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
...
class StockItem(models.Model):     
    ...
    item = models.ForeignKey(Item, on_delete=models.CASCADE)
    retail_price = models.DecimalField(max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    cost = models.DecimalField(max_digits=8, decimal_places=2)
    customer_price = models.DecimalField(max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    ...
    customer_discount = models.DecimalField(max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
